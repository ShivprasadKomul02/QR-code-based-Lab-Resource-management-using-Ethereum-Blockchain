...
<?php 
mysqli_query($conn,"update stdevice set dev_status='Repaired' where id = '$get_id'")or die(mysqli_error());
mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Repair Device $dev_name Inventory Code:$dev_serial')")or die(mysqli_error());						
