									   ...
									   <div class="control-group">
										...
										<div class="control-group">
		                                  <label class="control-label" for="inputEmail">Move TO</label>
				                            ...
				                            <option></option>
			                                 <?php $result =  mysqli_query($conn,"select * from stlocation")or die(mysqli_error()); 
										...
										mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','transfer Device  $dev_name to location id $stdev_id')")or die(mysqli_error());			
										?>
										<script>
