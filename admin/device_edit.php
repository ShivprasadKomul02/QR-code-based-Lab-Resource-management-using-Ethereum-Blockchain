						...
						<div class="span9" id="content">
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
									...
									<?php
									$query = mysqli_query("select * from stdevice 
									...
									?>
										...
										<div class="control-group">
											...
											<div class="controls">			
												<select id="qtype" name="dev_id" required>
													...
													<?php
													$device_query = mysqli_query("select * from device_name")or die(mysqli_error());
										...
										mysqli_query("update stdevice set dev_id = '$dev_id' ,
																		dev_desc = '$dev_desc',
									    ...
									    mysqli_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit device info $dev_name')")or die(mysqli_error());
										?>
										<script>										
