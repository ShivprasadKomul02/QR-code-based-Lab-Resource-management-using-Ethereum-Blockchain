                      ...
                      <div class="alert alert-success alert-dismissable">
                        ...
                        <div id="block_bg" class="block">
                           ...
                           <?php 
								...
								where dev_status = 'New' ORDER BY stdevice.id DESC")or die(mysqli_error());
								...
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								where dev_status = 'damage' OR dev_status = 'Damage' ORDER BY stdevice.id DESC")or die(mysqli_error());
								...
								<?php 
								$device_location = mysqli_query($conn,"select * from location_details")or die(mysqli_error());
			                    ...
			                    OR dev_name = '(kbrd)' ")or die(mysqli_error());
								...
								where dev_name = 'Monitor' OR dev_name = 'monitor'
			                     ...
			                     OR dev_name = '(monitor)' OR dev_name = '(montor)' ")or die(mysqli_error());
			                    ...
			                    OR dev_name = '(CPU)' OR dev_name = '(Central Processing unit (CPU))' ")or die(mysqli_error());
								...
								OR dev_name = '(power-supply)' OR dev_name = 'POWER SUPPLY' ")or die(mysqli_error());
			                    ...
			                    OR dev_name = 'vedeo graphic' OR dev_name = 'video graphic accelerator'")or die(mysqli_error());
								...
								OR dev_name = 'powe cor'  OR dev_name = 'power-cord'")or die(mysqli_error());
