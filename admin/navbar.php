				 ...
				 <div class="navbar-header">
				  ...
				  <!--.nav-collapse -->
                    <div class="nav-collapse collapse">
						...
						?> 
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"><img id="avatar1" class="img-responsive" src="images/pictlogo.png">&nbsp;<?php echo $row['role'];  ?> <i class="caret"></i>
                                </a>
