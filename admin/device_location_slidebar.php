     <div class="span3" id="sidebar">
	                <div class="empty">
					<img src="images/pictlogo.png" ?> </div>
					 <?php include('count.php'); ?>
                      ...
                      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li class="">						
                            ...
                            <li class="">
                            <a href="device_stocks.php"><i class="icon-chevron-right"></i><i class="icon-desktop"></i> Devices</a>
                            </li>
                            <li class="">
						...
						<li>						
						    ...
						    <li class="">
                            <a href="admin_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Lab Assistant</a>
                            </li>
						    </ul>
						</li>
						
						<li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs3"><i class="icon-chevron-right"></i><i class="icon-book"></i>&nbsp;Log
							<div class="muted pull-right"><i class="caret"></i></div></a>						
