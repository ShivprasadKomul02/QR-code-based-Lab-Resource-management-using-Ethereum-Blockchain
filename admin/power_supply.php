    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_item=mysqli_query("select * from stdevice 
...
<!-----------------------------------Content------------------------------------>
		...
		<tr>
		<td><?php
			   $device_query2 = mysqli_query("select * from stdevice ")or die(mysqli_error());
			...
			<td><?php
			   $device_query1 = mysqli_query("select * from stdevice ")or die(mysqli_error());
